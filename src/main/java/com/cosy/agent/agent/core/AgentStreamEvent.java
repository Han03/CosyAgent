 ...
 *   <li>{@code toolResult}：工具执行完成（content = 观察结果 JSON）</li>
...
public record AgentStreamEvent(
    ...
    public static AgentStreamEvent thinking(int index) {
        return new AgentStreamEvent("thinking", index, null, null, null, null, null, null, null, null, null, null);
    }

    public static AgentStreamEvent tool(String callId, String toolName, String arguments, int index) {
        return new AgentStreamEvent("tool", index, callId, toolName, arguments, null, null, null, null, null, null, null);
    }

    public static AgentStreamEvent toolResult(String callId, String toolName, String content) {
        return new AgentStreamEvent("toolResult", null, callId, toolName, null, content, null, null, null, null, null, null);
    }

    public static AgentStreamEvent answer(String text) {
        return new AgentStreamEvent("answer", null, null, null, null, text, null, null, null, null, null, null);
    }
    ...
    public static AgentStreamEvent error(String message) {
        return new AgentStreamEvent("error", null, null, null, null, null, null, null, null, null, null, message);
    }
}
